...
add_action(
  ...
  'admin_styles',           # Función que deseamos ejecutar
  10                        # Nivel de prioridad
);
...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
      ...
      wp_register_script( 'slicknav', get_template_directory_uri() . '/js/jquery.slicknav.min.js', array(), '1.0.10', true ); // Slicknav
...
if (function_exists('register_sidebar'))
{
    ...
    register_sidebar(array(
        'name' => __('Zona de cupones (Widget)', 'html5blank'),
...
function create_post_type_html5()
{
    ...
    register_post_type('tours', // Register Custom Post Type
        ...
        'labels' => array(
            ...
            'add_new_item' => __('Agregar Nuevo Tour', 'html5blank'),
            'edit' => __('Editar', 'html5blank'),
            'edit_item' => __('Editar Tour', 'html5blank'),
            'new_item' => __('Nuevo Tour', 'html5blank'),
            'view' => __('Ver Tours', 'html5blank'),
            'view_item' => __('Ver Tour', 'html5blank'),
